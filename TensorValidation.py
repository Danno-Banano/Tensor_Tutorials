...
def train_model(learning_rate, steps, batch_size, training_examples, training_targets, validation_examples,
    ...
    # Train the model, starting from previous state
...
linear_regressor = train_model(learning_rate=0.00003, steps=500, batch_size=5, training_examples=training_examples,
...
print("Final test RMSE: %0.2f" % test_root_mean_squared_error)
